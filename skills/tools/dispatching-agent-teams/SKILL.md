...
1. If the user provided a team name as argument, look for `teams/{name}.md` in the project directory, then user-level directories, then plugin cache.
2. If no argument, scan for available team files and present a selection menu.
