---
name: move-field
description: "Move Field refactoring technique - relocate fields between classes to improve encapsulation, reduce coupling, and align data with the classes that use it most"
---
