...
description: "Add a method to a class that you don't own by creating a foreign method. Use when you can't modify the original class but need to add functionality."
---
