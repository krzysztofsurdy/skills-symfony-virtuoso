---
name: symfony-asset
description: Manage URL generation and versioning of web assets (CSS, JavaScript, images). Provides flexible strategies for cache busting, CDN integration, and centralized asset management without hardcoded URLs.
---
