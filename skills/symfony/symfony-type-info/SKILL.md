...
description: Extract and work with PHP type information. Create, resolve, and validate types from properties, arguments, return types, unions, intersections, and generics. Handle array shapes, type aliases, and perform complex type checking operations.
---
