...
description: Execute and manage system commands and sub-processes with secure argument handling, timeout control, real-time output streaming, asynchronous execution, and cross-platform OS compatibility. Use this component to replace PHP functions like exec(), passthru(), and shell_exec() while preventing security vulnerabilities through automatic argument escaping.
---
