...
description: Validate values following JSR-303 Bean Validation specification. Use this skill to validate objects, raw scalar values, and arrays with built-in constraints or custom validation logic. Support validation groups, error severity levels, and message translation.
---
