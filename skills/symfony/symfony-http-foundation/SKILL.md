...
description: Manage HTTP requests and responses with an object-oriented layer that replaces PHP globals. Handle sessions, cookies, file uploads, streaming content, and HTTP caching with Request, Response, and related classes.
---
