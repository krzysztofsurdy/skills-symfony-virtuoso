...
description: Structural pattern that minimizes memory usage by sharing common state among multiple objects. Use when you have many similar objects that consume significant memory.
---
