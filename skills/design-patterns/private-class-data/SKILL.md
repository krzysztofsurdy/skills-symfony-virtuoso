...
description: Control write access to class data by delegating value assignments to a separate data holder object, making data immutable after construction.
---
