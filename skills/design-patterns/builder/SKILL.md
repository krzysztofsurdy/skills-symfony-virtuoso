...
description: >
  ...
  allowing you to construct objects step-by-step and produce different variants. Use it when
  dealing with complex objects with many optional parameters, when you need multiple constructors,
  or when construction involves many steps.
---
